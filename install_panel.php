...
function GetFos() {
    ...
    shell_exec("git clone https://github.com/micky4966/IPTV-MD.git /usr/src/FOS-Streaming/ > /dev/null");
...
function GetFOSResources($arch) {
    ...
    shell_exec("wget http://downloads.sourceforge.net/project/iptv-mdi/folder/{$fos} -O /home/fos-streaming/{$fos} > /dev/null");
