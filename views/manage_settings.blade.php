                ...
                <form id="demo-form2" data-parsley-validate="" class="form-horizontal form-label-left" novalidate="" role="form" action="" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            ...
                            <span class="label label-important">Important: restart nginx manualy ( killall -9 nginx_fos && /home/fos-streaming/fos/nginx/sbin/ ) And start ( /home/fos-streaming/fos/nginx/sbin/nginx_fos )</span>
                        </div>
                    </div>
